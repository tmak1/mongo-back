...
docker build -t 978344289623.dkr.ecr.ap-southeast-2.amazonaws.com/mongo-back .

docker push 978344289623.dkr.ecr.ap-southeast-2.amazonaws.com/mongo-back:latest

docker rmi 978344289623.dkr.ecr.ap-southeast-2.amazonaws.com/mongo-back:latest